  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <div class="top-nav notification-row">                
                ...
                {
                  echo "<li>";
                   echo "<a href='login.php'><i class=''></i>Connecter</a>";
                } echo "</li>";
                ?>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu"> 
                  ...
                  {
                  echo "<li>";
                  echo "<a class='' href='http://localhost/labo-user_2/index91.php?ident={$userRow['user_id']}'>"; 
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li><i class=""></i>Recherche</li>
            <li><i class=""></i>Axes de Recherches</li>
          </ol>
        </div>
      </div>
            <div class="row">
                <div class="col-lg-12">
                  <section class="panel">                        
                      <div class="panel-body">
                          <div class="panel-heading"><strong>PROGRAMME GLORY (Génie LOgiciel, enviRonnements intégrés et sYstèmes Communicants)</strong>
                          </div>
                                  <p>Responsables : Prof. Henda Hajjami Ben Ghézala & Dr. Naoufel Kraiem </p>
                                      <div class="col-lg-6">
                                                      <h3>Thèmes de recherche liés:</h3>
                                                      <p class="list-group-item-text">
                                                        <ol style="list-style-type:disc;">
                                                            <li>Ingénierie des methods et des processus collaboratifs, Ingénierie des exigences, Réutilisation</li>
                                                            <li>Qualité et sécurité logicielle</li>
                                                            <li>Internet des objets, Web sémantique, Ingénierie ontologique</li>
                                                            <li>TICE</li>
                                                            <li>Systèmes d’information intelligents et collaboratifs, Systèmes de recommandation</li>
                                                            <li>Architecture logicielle (SOA), Systèmes communiquant, Bases de données temps réel</li>
                                                            <li>Qualité et sécurité logicielle
                                                                Internet des objets, Web sémantique, Ingénierie ontologique</li>
                                                        </ol>
                                                      </p>
                                      </div>
                                      <div class="col-lg-6">
                                                      <h3>Mots clés :</h3>
                                                      <p class="list-group-item-text">
                                                        Génie Logiciel, Ingénierie de processus et de méthodes, Systèmes d’Information communicants et et d’aide à la décision, Bases de Données Temps Réel, Ingénierie du web et internet des objets, Architecture LOGICIELLE , Plateformes Technologiques, Réingénierie et urbanisation des systèmes, Réutilisation de composants logiciels et Lignes de Produits, Qualité et sécurité des systèmes, TIC pour l’éducation
                                                      </p>
                                      </div>
