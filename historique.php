...
<!--                   <li class="sub-menu ">
 ...
 -->                  <li class="sub-menu ">
      ...
      <div class="row">
        <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa fa-bars"></i>Historique</h3>
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i><a href="evenements.php">Acceuil</a></li>
                        <li><i class=""></i>Présentaion</li>
            <li><i class=""></i>Historique</li>
          </ol>
        </div>
      </div>
         <div class="row">
                      ...
                      <section class="panel">
                          <div class="panel-body progress-panel">
                            <div class="row">
                              <div class="col-lg-8 task-progress pull-left">
                                  <h1><span class="logo" class="pull-left"></span>LABORATOIRE <span class="lite">RIADI</span><br/></h1>
                              </div>
                              <div class="col-lg-4">
                                <span class="profile-ava pull-right">
                                        <img alt="" class="simple" src="img/bg-3.jpg">
                                </span>
                          ...
                          <table class="table table-hover personal-task">
                              ...
                              <tr>
                                  <td>2003</td>
                                  <td>
                                    STRATEGIE – RIADI/CRI Sorbonne CMCU
                                  </td>
                                  <td></td>
                              <tr>
                              <tr>
                                  <td>1999</td>
                                  <td>
                                    HABILISATION DU LABORATOIRE RIADI
                                  </td>
                                  <td></td>
                              </tr>
                              </tbody>
