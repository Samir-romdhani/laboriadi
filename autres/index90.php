                ...
                <ul class="nav pull-right top-menu">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li>
                                <a href="http://localhost/labo-user_2/User/logout.php?logout=true"><i class="icon_key_alt"></i> Deconnecter</a>
                            </li>
                            <li>
          ...
          <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><i class="icon_group"></i>Membres</li>
                    </ol>
                </div>
            </div>
              <!-- page start-->
